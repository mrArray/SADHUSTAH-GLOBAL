...
export default class Menu_Aside extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div className="card card-custom card-stretch">
         ...
         {/*begin:Item*/}
         <div className="navi-item my-2">
                <Link to="/ViewProjects" className="navi-link">
                  <span className="navi-icon mr-4">
                    <span className="svg-icon svg-icon-xl">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg*/}
                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                  ...
                  <span className="navi-text font-weight-bolder font-size-lg">View Project </span>
                  <span className="navi-label">
                  </span>
                </Link>
              </div>
         ...
         {/*begin:Item*/}
         <div className="navi-item my-2">
                <Link to="/AssignTask" className="navi-link">
                  <span className="navi-icon mr-4">
                    <span className="svg-icon svg-icon-xl">
              ...
              {/*begin:Item*/}
         <div className="navi-item my-2">
                <Link to="/ViewTasks" className="navi-link">
                  <span className="navi-icon mr-4">
                    <span className="svg-icon svg-icon-xl">
                      {/*begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg*/}
                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                  ...
                  <span className="navi-text font-weight-bolder font-size-lg">View Task </span>
                  <span className="navi-label">
                  </span>
                </Link>
              </div>
