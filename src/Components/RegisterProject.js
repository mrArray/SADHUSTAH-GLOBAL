                      ...
                      <div className="col-xl-12 col-xxl-7">
                        ...
                        <form className="form" id="kt_form">
                              ...
                              <div className="col-xl-12">
                                ...
                                <div className="form-group">
                                  ...
                                  <select name="country" className="form-control form-control-solid form-control-lg">
                                    ...
                                    <option value="AU" selected="selected">Bridge</option>
                          ...
                          <div className="pb-5" data-wizard-type="step-content">
                            <h4 className="mb-10 font-weight-bold text-dark">Enter the Project Location</h4>
                            {/*begin::Input*/}
                            <div className="form-group">
                              <label>Address</label>
                              <textarea type="text" className="form-control form-control-solid form-control-lg" name="package" placeholder="Package Details" defaultValue="Complete Workstation (Monitor, Computer, Keyboard & Mouse)" />
                              <span className="form-text text-muted">Please enter project Address.</span>
                            </div>
                            {/*end::Input*/}
                            {/*begin::Input*/}
                            {/* <div className="form-group">
                            ...
                            <div className="row">
                              <div className="col-xl-12">
                                {/*begin::Input*/}
                                 ...
                                 <div className="form-group">
                                  ...
                                  <select name="country" className="form-control form-control-solid form-control-lg">
                                    <option value>Select</option>
                                    <option value="AF" selected="selected">Kano</option>
                                    <option value="AX">Åland Islands</option>
                                    <option value="AL">Albania</option>
                                    <option value="DZ">Algeria</option>
                                    <option value="AS">American Samoa</option>
                              ...
                              <div className="col-xl-12">
                                ...
                                <div className="form-group">
                              <label>LG</label>
                              <input type="text" className="form-control form-control-solid form-control-lg" name="lg" placeholder="LG" defaultValue="Dala" />
                              <span className="form-text text-muted">Please enter LG.</span>
                            </div>
                                {/*end::Input*/}
                              </div>
                          ...
                          <div className="pb-5" data-wizard-type="step-content">
                            ...
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control form-control-solid form-control-lg" name="startdate" placeholder="startdate" defaultValue="startdate" />
                            ...
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control form-control-solid form-control-lg" name="duedate" placeholder="duedate" defaultValue="duedate" />
