        ...
        <div className="dropdown">
          ...
          <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
            <form>
              ...
              {/*end::Header*/}
              {/*begin::Scroll*/}
              <div className="scroll scroll-push ps" data-scroll="true" data-height={250} data-mobile-height={200} style={{height: 250, overflow: 'hidden'}}>
                {/*begin::Item*/}
                <div className="d-flex align-items-center justify-content-between p-8">
                  <div className="d-flex flex-column mr-2">
                    ...
                    <span className="text-muted">Best kichen gadget in 2020</span>
                ...
                <div className="d-flex align-items-center justify-content-between p-8">
                  <div className="d-flex flex-column mr-2">
                    <a href="#" className="font-weight-bold text-dark text-hover-primary">4DPrinter</a>
                ...
                {/*end::Item*/}
                <div className="ps__rail-x" style={{left: 0, bottom: 0}}><div className="ps__thumb-x" tabIndex={0} style={{left: 0, width: 0}} /></div><div className="ps__rail-y" style={{top: 0, right: 5}}><div className="ps__thumb-y" tabIndex={0} style={{top: 0, height: 0}} /></div></div>
              {/*end::Scroll*/}
              {/*begin::Summary*/}
              <div className="p-8">
        ...
        <div className="topbar-item">
          <div className="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
            <div className="d-flex flex-column text-right pr-sm-3">
              <span className="text-white opacity-50 font-weight-bold font-size-sm d-none d-sm-inline">Sean</span>
