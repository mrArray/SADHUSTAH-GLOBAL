      ...
      <div className="navi-item my-2">
                            <Link to="/dashboard" className="navi-link">
                              <span className="navi-icon mr-4">
                                <span className="svg-icon svg-icon-xl">
                                  {/*begin::Svg Icon | path:./assets/dist/assets/media/svg/icons/General/Trash.svg*/}
                          ...
                          <div className="navi-item my-2">
                            <Link to="/allprojects" className="navi-link">
                              <span className="navi-icon mr-4">
                                <span className="svg-icon svg-icon-xl">
                                  {/*begin::Svg Icon | path:./assets/dist/assets/media/svg/icons/General/Half-star.svg*/}
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                          ...
                          <div className="navi-item my-2">
                            <Link to="/alltasks" className="navi-link">
                              <span className="navi-icon mr-4">
                                <span className="svg-icon svg-icon-xl">
                                  {/*begin::Svg Icon | path:./assets/dist/assets/media/svg/icons/Communication/Sending.svg*/}
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                      <rect x={0} y={0} width={24} height={24} />
        ...
        <div className="card-body pt-4">
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Air B</a>
          ...
          <div className="mb-7">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <a href="#" className="text-muted text-hover-primary">$249,500</a>
            </div>
      ...
      <div className="card card-custom gutter-b card-stretch">
        ...
        <div className="card-body pt-4">
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            {/*begin::Title*/}
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Ad Brand</a>
          ...
          {/*end::Info*/}
          <a href="#" className="btn btn-block btn-sm btn-light-danger font-weight-bolder text-uppercase py-4">Edit Task</a>
        </div>
        {/*end::Body*/}
      </div>
      {/*end:: Card*/}
      ...
      <div className="card card-custom gutter-b card-stretch">
        ...
        <div className="card-body pt-4">
              ...
              <div className="dropdown-menu dropdown-menu-md dropdown-menu-right">
                ...
                <ul className="navi">
                  ...
                  <li className="navi-footer pt-5 pb-4">
                    ...
                    <a className="btn btn-clean font-weight-bold btn-sm d-none" href="#" data-toggle="tooltip" data-placement="right" title data-original-title="Click to learn more...">Learn more</a>
                  </li>
                </ul>
                {/*end::Naviigation*/}
              </div>
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            {/*begin::Title*/}
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Nexa</a>
          ...
          {/*end::Info*/}
          <a href="#" className="btn btn-block btn-sm btn-light-info font-weight-bolder text-uppercase py-4">Edit Task</a>
        </div>
        {/*end::Body*/}
      </div>
      {/*end:: Card*/}
      ...
      <div className="card card-custom gutter-b card-stretch">
        ...
        <div className="card-body pt-4">
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            {/*begin::Title*/}
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Citrix</a>
      ...
      <div className="card card-custom gutter-b card-stretch">
        ...
        <div className="card-body pt-4">
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            {/*begin::Title*/}
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Gap</a>
      ...
      <div className="card card-custom gutter-b card-stretch">
        ...
        <div className="card-body pt-4">
          ...
          <div className="d-flex align-items-center mb-7">
            ...
            {/*begin::Title*/}
            <div className="d-flex flex-column">
              <a href="#" className="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Nokia</a>
          ...
          {/*end::Info*/}
          <a href="#" className="btn btn-block btn-sm btn-light-warning font-weight-bolder text-uppercase py-4">Edit Task</a>
        </div>
        {/*end::Body*/}
      </div>
      {/*end:: Card*/}
